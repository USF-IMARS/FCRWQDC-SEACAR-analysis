...
This analysis compares rate of change for each station+parameter as calculated from the old and new datasets.
Only slopes with significant p-values for in both datasets are considered in this analysis.
...
Points are expected to be above the diagonal because the new dataset has more points than the old dataset.
...
Some station points can form lines parallel to the 1:1 line.
...
Slopes with lower `n_values` are more likely to be spurious.
...
New data is plotted in red and old data in blue.
