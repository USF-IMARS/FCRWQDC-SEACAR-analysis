...
# Find ProgramLocationIDs that exist in SEACAR_STD but not in OLD_STD
...
cat("Number of ProgramLocationIDs in SEACAR_STD but not in OLD_STD:", length(seacar_only), "\n")
cat("First few ProgramLocationIDs in SEACAR_STD but not in OLD_STD:", head(seacar_only), "\n")


cat("Number of ProgramLocationIDs in OLD_STD but not in SEACAR_STD:", length(old_only), "\n")
