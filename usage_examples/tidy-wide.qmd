...
The default data file is in "long" format, with "analyte name" as a column. 
...
```{R load-data}
#| code-summary: load dashboardData.csv
...
This identifier can be built from `{ProgramName}-{ProgramLocationID}-{depth}`.
