...
```{R, show number of duplicate rows for each}
#| code-summary: show number of duplicate rows for each dataset
cat("SEACAR duplicates:", nrow(df_SEACAR) - nrow(unique(df_SEACAR)), "\n")
cat("OLD duplicates:", nrow(df_OLD) - nrow(unique(df_OLD)), "\n")
```
...
```{R, show number of duplicate rows for each after column selection}
#| code-summary: show number of duplicate rows for each dataset after column selection
cat("SEACAR duplicates:", nrow(df_SEACAR) - nrow(unique(df_SEACAR)), "\n")
cat("OLD duplicates:", nrow(df_OLD) - nrow(unique(df_OLD)), "\n")
```
