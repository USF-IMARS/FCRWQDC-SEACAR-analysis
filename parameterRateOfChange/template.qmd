...
format: html
params:
  batch_value: "Salinity" #Total Ammonia (N)"  # must match value in generate_batch_qmds.R
...
sample_stats_df <- df %>%
  group_by(ProgramName, ProgramLocationID, OriginalLongitude, OriginalLatitude) %>%
  summarize(
