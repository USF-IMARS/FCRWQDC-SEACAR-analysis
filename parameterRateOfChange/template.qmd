...
sample_stats_df <- df %>%
  group_by(ProgramName, ProgramLocationID, ParameterUnits) %>%
  summarize(
    AverageLatitude  = mean(OriginalLatitude,  na.rm = TRUE),
    AverageLongitude = mean(OriginalLongitude, na.rm = TRUE),
